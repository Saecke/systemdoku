...
- `antispam`: 60s Cleanup-Loop (History + abgelaufene Strikes)
...
- `antispam`: Alle Kanaele (ausser excluded) -> Spam-Erkennung (Duplikate, Flood, Cross-Channel, Mass Mentions)
...
| `cfg.antispam.*` | AntiSpam-Konfig | `cfg.antispam.action`, `cfg.antispam.duplicate_spam.enabled` |
